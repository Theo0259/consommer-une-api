...
//       const isDescVisible = !descDiv.classList.contains('hidden');
  
//       // Vérifiez si le clic s'est produit en dehors de la div "card" et de la div "desc"
//       if (!clickedCard && !event.target.closest('#desc') && isDescVisible) {
//         // Masquez la div "desc" en ajoutant la classe "hidden"
//         descDiv.classList.add('hidden');
//       }
//     });
...
//       // Vérifiez si le clic s'est produit en dehors de la div "card" et de la div "desc"
//       if (!clickedCard && !event.target.closest('#desc') && isDescVisible) {
//         // Ajoutez un court délai avant de masquer la div "desc"
//         setTimeout(() => {
//           descDiv.classList.add('hidden');
//         }, 10);
//       }
